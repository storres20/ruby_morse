...
- [📖 \[Morse Code Project\] ](#-morse-code-project-)
...
> This project is for decoding a message written in Morse code with Ruby technology.

**[Morse Code Project]** is for decoding a morse code.
...
```sh
  cd ruby_morse
  git clone https://github.com/storres20/ruby_morse.git
```
...
- [ ] **[convert text into morse code message]**
...
Feel free to check the [issues page](https://github.com/storres20/ruby_morse/issues).
